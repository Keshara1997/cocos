  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerController", PlayerController = (_dec = ccclass("PlayerController"), _dec2 = property(RigidBody2D), _dec3 = property(Animation), _dec4 = property(Prefab), _dec(_class = (_class2 = class PlayerController extends Component {
        ...
        jump() {
          var jumpPower = this.jumpForce; // If player is on a jumper and manually jumps, give extra boost
        ...
        throwBomb() {
          ...
          var bomb = instantiate(this.Bomb_Prefab);
          ...
          if (bombRigidBody) {
            var impulseX = 10 * this.facingDirection;
            var impulseY = 5;
