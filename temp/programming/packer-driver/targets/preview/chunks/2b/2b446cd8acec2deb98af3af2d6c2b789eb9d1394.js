    ...
    execute: function () {
      ...
      _export("signUp", signUp = (_dec = ccclass('signUp'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class signUp extends Component {
        ...
        onClickSignUp() {
          ...
          var userName = this.signUp_UserName_EditBox.getComponent(EditBox).string;
          var password = this.signUp_Password_EditBox.getComponent(EditBox).string;
          var name = this.signUp_Name_EditBox.getComponent(EditBox).string;
